...
var ASM_CONSTS = {
  69704: () => { FS.syncfs(false, function(err) { if (err) { console.error('Failed to sync to IndexedDB:', err); } else { console.log('Saved to IndexedDB.'); } }); },  
 69855: () => { console.log('BST Loaded and Flights Printed to Console'); },  
 69917: () => { FS.syncfs(false, function(err) { if (err) { console.error('Failed to sync to IndexedDB:', err); } else { console.log('Saved to IndexedDB.'); } }); }
};
var wasmImports = {
  /** @export */
...
var _addFlight = Module['_addFlight'] = createExportWrapper('addFlight', 8);
